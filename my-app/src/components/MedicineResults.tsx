...
// ✅ Resolve image URLs robustly
const resolveImageUrl = (img: string | undefined | null) => {
  if (!img) return medpic;
...
export function MedicineResults({
  ...
  return (
    <>
        ...
        {results.map((med, idx) => (
          ...
          >
            <img
              ...
              onError={(e) => (e.currentTarget.src = medpic)}
            />
            ...
            <p className="text-lg font-semibold text-[#002E6E] tracking-wide">
              Price: ₹{med.price}
            </p>
      ...
      {/* Toast container included here, no need to modify App.tsx */}
